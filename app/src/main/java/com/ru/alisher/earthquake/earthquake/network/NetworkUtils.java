package com.ru.alisher.earthquake.earthquake.network;
...
public class NetworkUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl, Context context) {
        ...
        List<Earthquake> earthquakes = extractFeatureFromJson(jsonResponse, context);
     ...
     */
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON, Context context) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                String detailUrl = properties.getString("detail");
                 ...
                 */
                Earthquake earthquake = new Earthquake(id, magnitude, mercalliIntensityScale, alertLevel, lat,
                        lon, location, locationOffset, timeInMilliseconds, detailUrl);
